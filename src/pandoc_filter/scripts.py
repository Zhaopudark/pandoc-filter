...
import filters.md2md.figure
import filters.md2md.footnote
import filters.md2md.internal_link
import filters.md2md.math

import filters.md2html.anchor
import filters.md2html.figure
import filters.md2html.internal_link
import filters.md2html.link_like
...
def md2md_figure_filter(doc=None,**kwargs):
    ...
    return pf.run_filters(actions=[filters.md2md.figure.figure_filter],doc=doc,oss_helper=oss_helper,**kwargs)

@pandoc_filer_wrapper
def md2md_footnote_filter(doc=None,**kwargs):
    return pf.run_filters(actions=[filters.md2md.footnote.footnote_filter],doc=doc,**kwargs)

@pandoc_filer_wrapper
def md2md_internal_link_filter(doc=None,**kwargs):
    return pf.run_filters(actions=[filters.md2md.internal_link.internal_link_filter],doc=doc,**kwargs)

@pandoc_filer_wrapper
def md2md_math_filter(doc=None,**kwargs):
    return pf.run_filters(actions=[filters.md2md.math.math_filter],doc=doc,**kwargs)
...
def md2html_anchor_and_internal_link_filter(doc=None,**kwargs):
    ...
    return pf.run_filters(
        actions= [
            filters.md2html.anchor.anchor_filter,
            filters.md2html.internal_link.internal_link_recorder],
        finalize=_finalize,
        doc=doc,**kwargs)

@pandoc_filer_wrapper
def md2html_figure_filter(doc=None,**kwargs):
    return pf.run_filters(actions= [filters.md2html.figure.figure_filter],doc=doc,**kwargs)

@pandoc_filer_wrapper
def md2html_link_like_filter(doc=None,**kwargs):
    return pf.run_filters(actions= [filters.md2html.link_like.link_like_filter],doc=doc,**kwargs)
